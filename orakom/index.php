...
<head>
  ...
  <title>PROJECT Votting Wisata</title>
  <link rel="icon" href="asset/cepmek.jpg">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
  <link rel="stylesheet" href="style.css">
  <!-- Jquery luar tampilan web -->
...
<body>
  ...
  <section id="home" class="homepage">
    <h1 class="text-center b-dark pt-5 fw-bolder">Silahkan untuk memilih tempat wisata dibawah ini</h1>
    <!-- main content Start -->
    <div class="container px-4 text-center pb-5 ">
      <div class=" row gx-5 my-5 p-3 border b-dark">
        <div class="col mt-3">
          <img src="asset/borobudur.jpg" alt="" width="250px">
          <h3 class="mt-3 p-3 border b-dark">Borobudur</h3>
          <h3 class="mt-3 p-2 mx-4 border b-dark"><span id="cekdata1">loading</span></h3>
        </div>
        <div class="col mt-3">
          <img src="asset/kotalama.jpeg" alt="" width="250px">
          <h3 class="mt-3 p-3 border b-dark">Kotalama</h3>
          <h3 class="mt-3 p-2 mx-4 border b-dark"><span id="cekdata2">loading</span></h3>
        </div>
        <div class="col mt-3">
          <img src="asset/lawangsewu.jpg" alt="" width="250px">
          <h3 class="mt-3 p-3 border b-dark">LawangSewu</h3>
      ...
      <div class="mt-2">
        <table class="table table-secondary	 table-striped text-capitalize" name="number_of_rows" id="table_id">
          <tr class="table-info">
            ...
            <th scope="col">borobudur</th>
            <th scope="col">kotalama</th>
            <th scope="col">lawangsewu</th>
          </tr>
          </thead>
          <tbody>
            <!-- filter Start -->
            ...
            if(isset($_POST['filter'])){
              ...
              $kartu = mysqli_query ($conn,"SELECT * FROM orakom WHERE date BETWEEN '$dari_tgl' AND '$sampai_tgl' ORDER BY id DESC") ;
            } else {
              $kartu = mysqli_query($conn,"SELECT * FROM orakom ORDER BY id DESC");
            } 
            if(isset($_POST['all'])){
              $kartu = mysqli_query($conn,"SELECT * FROM orakom ORDER BY id DESC");
        ...
        <div class="btn-group">
          ...
          <div
            style="display: inline-block; position:relative; border: 0px solid #e3e3e3; justify-content:center; margin-left: 2px;;">
